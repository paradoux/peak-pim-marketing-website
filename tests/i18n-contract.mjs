...
if (existsSync(sitemapFile)) {
  ...
  for (const locale of translatedLocales) {
    ...
    if (localeEntries.length !== 40) failures.push(`Expected 40 ${locale} public pages, found ${localeEntries.length}`);
...
console.log("Internationalization contract passed for 320 localized public pages across 8 translated locales.");
