...
for (const feature of [
  ...
  { name: "custom-integrations", path: "/custom-integrations", aria: "Peak PIM custom integration map connecting supplier, ERP, logistics, and B2B and B2C store systems through validated catalog data flows", motion: ".peak-ci-peak > span:last-child" },
