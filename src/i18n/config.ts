...
export const localizedRoutes: LocalizedRoute[] = [
  ...
  route("custom-integrations", { en: "/custom-integrations", fr: "/fr/integrations-sur-mesure", de: "/de/individuelle-integrationen", es: "/es/integraciones-personalizadas", it: "/it/integrazioni-personalizzate", nl: "/nl/maatwerkintegraties", "pt-br": "/pt-br/integracoes-personalizadas", pl: "/pl/integracje-niestandardowe", ja: "/ja/custom-integration" }),
  ...
  route("customer-house-of-staunton", { en: "/customers/house-of-staunton", fr: "/fr/clients/house-of-staunton", de: "/de/kunden/house-of-staunton", es: "/es/clientes/house-of-staunton", it: "/it/clienti/house-of-staunton", nl: "/nl/klanten/house-of-staunton", "pt-br": "/pt-br/clientes/house-of-staunton", pl: "/pl/klienci/house-of-staunton", ja: "/ja/customers/house-of-staunton" }),
  route("customer-du-bruit-dans-la-cuisine", { en: "/customers/du-bruit-dans-la-cuisine", fr: "/fr/clients/du-bruit-dans-la-cuisine", de: "/de/kunden/du-bruit-dans-la-cuisine", es: "/es/clientes/du-bruit-dans-la-cuisine", it: "/it/clienti/du-bruit-dans-la-cuisine", nl: "/nl/klanten/du-bruit-dans-la-cuisine", "pt-br": "/pt-br/clientes/du-bruit-dans-la-cuisine", pl: "/pl/klienci/du-bruit-dans-la-cuisine", ja: "/ja/customers/du-bruit-dans-la-cuisine" }),
];
