...
export const pricingPlans: PricingPlan[] = [
  {
    ...
    highlights: ["1 store", "5,000 SKUs", "1 Drop/mo"],
  ...
  },
  {
    ...
    monthlyPrice: "$99",
    annualPrice: "$990",
    summary: "For lean teams managing a growing catalog in one store.",
    highlights: ["1 store", "Unlimited SKUs", "2 Drops/mo"],
    ctaLabel: "Get Peak PIM",
    ctaHref: "https://apps.shopify.com/peak-pim",
  },
  {
    ...
    highlights: ["2 stores", "Unlimited SKUs", "Unlimited Drops"],
    ctaLabel: "Get Peak PIM",
    ctaHref: "https://apps.shopify.com/peak-pim",
  },
  {
...
export const pricingFeatureGroups: PricingFeatureGroup[] = [
  {
    ...
    features: [
      ...
      {
        label: "SKUs",
        description: "Basic includes up to 5,000 SKUs. Core and Elite include unlimited SKUs under fair usage.",
        href: "/shopify-product-management",
        values: ["5,000", "Unlimited, fair usage", "Unlimited, fair usage", "Custom"],
      },
      {
        label: "File storage",
